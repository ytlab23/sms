...
const requestRefund = async (id: string) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      ...
      {numberDetails?.status === 'expired' && !smsList.length && !numberDetails?.refunded && (
        <>
          ...
          <Dialog open={isRefundDialogOpen} onOpenChange={setIsRefundDialogOpen}>
            <DialogContent className="bg-white">
              <DialogHeader>
                <DialogTitle>Are you sure you want to request a refund?</DialogTitle>
                <DialogDescription>
                  This action will initiate a refund process. Please confirm your request.
                </DialogDescription>
              </DialogHeader>
              <DialogFooter>
      ...
      {/* Refunded Text */}
      {numberDetails?.refunded && <p className="text-sm text-red-500">Refunded!</p>}
    </>
