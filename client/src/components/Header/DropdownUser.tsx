...
const DropdownUser = () => {
  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      {/* <!-- Dropdown Start --> */}
      {dropdownOpen && (
        <div className="absolute z-999 right-0 mt-4 w-64 flex flex-col rounded-lg border border-gray-200 bg-white dark:bg-boxdark shadow-lg dark:border-gray-700 dark:bg-gray-800 overflow-hidden transition-all duration-300 ease-in-out transform hover:scale-102">
          <ul className="flex flex-col border-b border-gray-200 dark:border-gray-700">
            <li>
              ...
              >
                ...
                />
                <span className="flex-grow">{t('header.Account Settings')}</span>
                <ChevronRight
              ...
              >
                ...
                />
                <span className="flex-grow">{t('header.Topup Balance')}</span>
                <ChevronRight
                  className={`w-5 h-5 transition-all duration-300 ${
                    hoveredItem === 'pay'
                      ? 'opacity-100 translate-x-0 text-blue-600 dark:text-blue-400'
              ...
              {isAdminEmail(currentUser?.email) && (
                ...
                >
                  ...
                  />
                  <span className="flex-grow">{t('header.Admin')}</span>
                  <ChevronRight
                    className={`w-5 h-5 transition-all duration-300 ${
                      hoveredItem === 'admin'
                        ? 'opacity-100 translate-x-0 text-blue-600 dark:text-blue-400'
          ...
          <button
            ...
            onClick={() => {
              ...
              navigate(`${i18n.language}/auth/signin`);
            }}
          ...
          >
            ...
            />
            <span className="flex-grow">{t("header.Log Out")}</span>
            <ChevronRight
              className={`w-5 h-5 transition-all duration-300 ${
                hoveredItem === 'logout'
