...
// // //     { name: t('header.SERVICES'), href: `${i18n.language}/ourservices` , icon: Server },
// // //     { name: t('header.STATISTICS'), href: `${i18n.language}/statistics`, icon: BarChart4Icon },
...
// // //   const authNavItems = [
// // //     { name: t('header.YOUR ORDERS'), href: `${i18n.language}/orders`, icon: ShoppingBag }, 
// // //   ];
