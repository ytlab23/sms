...
// import { Home, HelpCircle, UserPlus, LogIn, ShoppingBag, BookOpen, Shield, BarChart4 } from "lucide-react"
...
//     { name: t("header.FAQ"), href: `${i18n.language}/faq`, icon: HelpCircle },
//     { component: ServiceDropdown },
//     { name: t("header.STATISTICS"), href: `${i18n.language}/statistics`, icon: BarChart4 },
//     { name: t("header.HOW TO BUY"), href: `${i18n.language}/howtobuy`, icon: BookOpen },
//   ]

//   const guestNavItems = [
//     { name: t("header.SIGN UP"), href: `${i18n.language}/auth/signup`, icon: UserPlus },
//     { name: t("header.LOGIN"), href: `${i18n.language}/auth/signin`, icon: LogIn },
//   ]

//   const authNavItems = [{ name: t("header.YOUR ORDERS"), href: `${i18n.language}/orders`, icon: ShoppingBag }]

//   const adminNavItem = { name: t("header.ADMIN"), href: `${i18n.language}/admin382013453sms/setup`, icon: Shield }
...
//               <img className="h-6" src={LogoIcon || "/placeholder.svg"} alt="Logo" />
...
//               <li key={item.name || `nav-item-${index}`}>
...
const Header = (props: {
  ...
  const commonNavItems = [
    { name: t('header.HOME'), href: `/${i18n.language}/`, icon: Home },
    { name: t('header.CONTACT'), href: `/${i18n.language}/contact`, icon: HelpCircle },
    { component: ServiceDropdown },
    {
      name: t('header.STATISTICS'),
      href: `/${i18n.language}/statistics`,
      icon: BarChart4,
    },
    {
      name: t('header.HOW TO BUY'),
      href: `/${i18n.language}/howtobuy`,
      icon: BookOpen,
    },
  ];
  ...
  const authNavItems = [
    {
      name: t('header.YOUR ORDERS'),
      href: `/${i18n.language}/orders`,
      icon: ShoppingBag,
    },
  ];
  ...
  const adminNavItem = {
    name: t('header.ADMIN'),
    href: `/${i18n.language}/admin382013453sms/setup`,
    icon: Shield,
  };
    ...
    <header className="sticky top-0 z-[999] flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 ">
          ...
          //     alt="Logo"
          //     />
          //     <h1 className="font-bold text-sm sm:text-lg md:text-xl lg:text-2xl text-blue-600">
          //       SmsApp
          //     </h1>
          //   </NavLink>
        ...
        <div className="flex flex-col w-full">
          ...
          <ul className="mt-4 mb-5.5 hidden lg:flex gap-2 pl-6 self-center">
            {navItems.map((item, index) => (
              <li key={item.name || `nav-item-${index}`}>
                {'component' in item && item.component ? (
                  <item.component />
