...
import { Mail, Phone, MapPin, Send, User, MessageSquare, ShieldAlert } from "lucide-react"
...
// Updated schema to include recaptcha validation
...
export function Contact() {
  ...
  // Reset recaptcha when component mounts to ensure it's fresh
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const emailData = {
        ...formValues,
        "g-recaptcha-response": recaptchaValue, // Add this for server-side verification
      }
    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-xl max-w-2xl mx-auto text-muted-foreground">
          {t("contact.Have questions or need assistance? Reach out to our team.")}
        </p>
      </div>
      ...
      <Card className="shadow-xl border-t-4 border-t-blue-500 dark:border-t-blue-400 mb-12 max-w-3xl mx-auto">
        <CardHeader className="pb-0">
          <CardTitle className="text-2xl text-center">{t("contact.Send us a Message")}</CardTitle>
        </CardHeader>
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`${errors.name ? "border-red-500" : ""} h-12 rounded-md`}
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`${errors.email ? "border-red-500" : ""} h-12 rounded-md`}
                />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`${errors.subject ? "border-red-500" : ""} h-12 rounded-md`}
              />
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className={`${errors.message ? "border-red-500" : ""} rounded-md resize-none`}
              />
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <label className="text-sm font-medium">{t("contact.Verify you're human")}</label>
              </div>
              <div className="flex justify-center">
                <ReCAPTCHA
                  ref={recaptchaRef}
                  sitekey="6LeAzvgqAAAAAOyQJH97chSuOHhm2ude4OP5L5me"
