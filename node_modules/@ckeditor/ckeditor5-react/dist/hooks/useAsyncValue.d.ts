...
import { type AsyncCallbackState } from './useAsyncCallback.js';
/**
 ...
 * ```
 */
export declare const useAsyncValue: <R>(callback: () => Promise<R>, deps: DependencyList) => AsyncValueHookResult<R>;
/**
 * The result of the `useAsyncValue` hook.
 */
export type AsyncValueHookResult<R> = Exclude<AsyncCallbackState<R>, {
    status: 'idle';
}>;
